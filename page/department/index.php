...
<div class="container-fluid">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Daftar Department</h6>
    </div>
    <div class="card-body">
      <!-- Tambah tombol di atas tabel -->
      <div class="mb-3">
        <a href="?page=department&aksi=add" class="btn btn-primary custom-btn">
      ...
      <div class="table-responsive">
        <table class="table table-bordered" id="Department" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            $sql = $koneksi->query("SELECT * FROM departments order by id");
            while ($data = $sql->fetch_assoc()) {
              ...
              <tr>
                ...
                <td>
                  <a href="?page=department&aksi=edit&id=<?php echo $data['id']; ?>" class="btn btn-info btn-sm custom-btn">
                    <i class="fas fa-edit"></i> Edit
                  </a>
                  <a href="?page=department&aksi=delete&id=<?php echo $data['id']; ?>" 
